    ...
    return (
        ...
        <div className=" mt-6 lg:w-2/5 md:w-1/2 sm:w-4/5 mx-auto p-8 space-y-3 rounded-xl shadow-2xl">
            ...
            <form onSubmit={handleSignUp} className="space-y-6 ng-untouched ng-pristine ng-valid">
                ...
                <button className="block w-full p-3 text-center rounded-sm text-gray-900 bg-violet-400 hover:bg-violet-500 transition duration-300">Sign Up</button>
            </form>
            ...
            <p className="text-xs text-center sm:px-6 text-gray-400">Already have an account? &nbsp;
                <Link to="/signin" className="hover:underline text-gray-700">Sign In</Link>
            </p>
        </div>
