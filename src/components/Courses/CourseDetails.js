        ...
        <div className='mt-12 grid lg:grid-cols-4 '>
            ...
            <div className='col-span-3 p-5'>
                <div className='flex justify-end mb-4'>
                    <button
                        className="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-gray-600 bg-gray-200 transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-gray-300 focus:shadow-outline focus:outline-none"
                    >Download &nbsp;<AiOutlineCloudDownload /> </button>
                </div>

                <section className="text-gray-800 bg-gray-100">
                    <div className="container flex flex-col mx-auto lg:flex-row">

                        <div className="w-full lg:w-1/3" style={{ backgroundImage: ({ thumbnail }), backgroundPosition: 'center', backgroundSize: 'cover' }}></div>
